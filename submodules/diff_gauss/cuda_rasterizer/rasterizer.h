...
public:
  ...
  static int forward(std::function<char *(size_t)> geometryBuffer,
                     ...
                     float *out_alpha, int *radii = nullptr,
                     bool debug = false);
  ...
  backward(const int P, int D, int M, int R, const float *background,
           ...
           char *binning_buffer, char *image_buffer, const float *accum_alphas,
           const float *dL_dpix, const float *dL_dpix_depth,
           const float *dL_dpix_dalpha, float *dL_dmean2D, float *dL_dconic,
           float *dL_dopacity, float *dL_dcolor, float *dL_ddepth,
