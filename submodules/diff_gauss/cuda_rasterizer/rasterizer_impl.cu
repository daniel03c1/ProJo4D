...
int CudaRasterizer::Rasterizer::forward(
    ...
    float *out_alpha, int *radii, bool debug) {
  ...
  CHECK_CUDA(FORWARD::render(
                 ...
                 geomState.depths, geomState.conic_opacity, out_alpha,
                 imgState.n_contrib, background, out_color, out_depth),
             debug)
...
void CudaRasterizer::Rasterizer::backward(
    ...
    char *img_buffer, const float *accum_alphas, const float *dL_dpix,
    const float *dL_dpix_depth, const float *dL_dpix_alpha, float *dL_dmean2D,
    float *dL_dconic, float *dL_dopacity, float *dL_dcolor, float *dL_ddepth,
  ...
  CHECK_CUDA(BACKWARD::render(
                 ...
                 accum_alphas, imgState.n_contrib, dL_dpix, dL_dpix_depth,
                 dL_dpix_alpha, (float3 *)dL_dmean2D, (float4 *)dL_dconic,
                 dL_dopacity, dL_dcolor, dL_ddepth),
             debug)
  ...
  CHECK_CUDA(BACKWARD::preprocess(
                 ...
                 (glm::vec3 *)dL_dmean3D, dL_dcolor, dL_ddepth, dL_dcov3D,
